...
```
[GTM-ID] Brief description of the change
```

### Examples

```
[GTM-1] Implement cron job scheduling tool
[GTM-2] Add job history resource
[GTM-3] Create notification prompts
```
